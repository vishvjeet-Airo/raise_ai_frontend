...
import { Send, X, Plus, Search } from "lucide-react";
...
export default function ChatSidebar({ isOpen, onClose, documentId, documentName }: ChatSidebarProps) {
  ...
  return (
    // Decreased width from w-96 to w-80 for a more compact sidebar
    <div className="w-80 bg-[#FBFBFB] border-l border-gray-200 flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col overflow-y-auto">
              ...
              >
                {msg.type === "bot" ? (
                  <div className="flex items-start space-x-2">
                    <div className="w-7 h-7 rounded-full bg-[#EEEEEE] flex items-center justify-center text-xs font-semibold text-[#767575] flex-shrink-0">
                      AI
                    </div>
        ...
        {/* Input Area */}
        <div className="border-t bg-[#FBFBFB] px-4 py-3">
